...
import cyberconnect_sample.api.WalletConnectKit
import cyberconnect_sample.api.WalletConnectKitConfig
import cyberconnect_sample.utils.i
import cyberconnect_sample.utils.safeLet
...
object WalletConnector : Session.Callback {
    ...
    fun init(
        ...
        WalletConnector.onConnected = onConnected
        WalletConnector.onDisconnected = onDisconnected
        loadSessionIfStored()
    }
